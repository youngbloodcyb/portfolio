    ...
    <div class="w-10/12">
        ...
        <div class="my-6">
            <ul class="flex flex-row justify-center md:justify-start gap-4 flex-wrap">
                ...
                <div class="h-auto w-full md:w-48 flex flex-col border-black border-solid border-2 rounded-2xl hover:shadow-[-6px_6px_#000] transition-shadow duration-300 ease-in-out">
