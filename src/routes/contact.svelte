...
<div class="flex items-center flex-col h-auto font-roboto">
    <Nav/>
    <div class="w-10/12">
        <h1 class="text-5xl md:text-6xl font-extrabold py-2">need to get in touch?</h1>
        <h2 class="text-3xl md:text-4xl font-extrabold py-2 text-green mb-4">feel free to drop me a message if you'd like<br> to work together or get in contact with me.</h2>
