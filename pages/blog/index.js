    ...
    return (
        <div data-scroll-section>
            ...
            <div className="z-0 flex justify-center items-center text-center font-grid w-full h-[800px]" data-scroll data-scroll-speed="-4">
                <div className="mx-36">
                    <h1 className="text-5xl lg:text-8xl text-blue-400">checkout some of my writings, pulled <br></br>from my medium</h1>
                </div>
            </div>
            <ul className="flex flex-col md:flex-row" data-scroll data-scroll-speed="0">
                {posts.map((post, index) => {
                    const { title, pubDate } = post;
                    return (
                        <li className="bg-gray w-full md:w-1/3 rounded-xl border-solid border-black border-2" key={index}>
