        ...
        <div data-scroll-section>
            <main>
                ...
                <div className="z-0 flex justify-center items-center text-center font-grid w-full h-[800px]" data-scroll data-scroll-speed="-4">
                    <div className="mx-36">
                        <h1 className="lowercase text-5xl lg:text-8xl text-blue-400">hi, i'm a full-stack developer</h1>
                    </div>
                </div>
                ...
                <div className="flex justify-center items-center text-center font-grid w-full h-[500px]" data-scroll data-scroll-speed="2">
                    <div className="mx-36">
                        <h1 className="text-5xl lg:text-8xl text-blue-400">i'm passionate about agile development and shipping quality code</h1>
                    </div>
                </div>
